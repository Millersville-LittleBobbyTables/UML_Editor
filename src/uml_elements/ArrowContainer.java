...
public class ArrowContainer
{
    ...
    */
	public void add(String arrowType, double beginX, double beginY, double endX, double endY)
	{
        ...
        if      (index == 0)
        {
            arrow = new Arrow(arrowType, arrows.size(), false, true, true);
        }
        else if (index == 1)
        {
            arrow = new Arrow(arrowType, arrows.size(), true,  true, true);  
        }
        else if (index == 2)
        {
            arrow = new Arrow(arrowType, arrows.size(), false, true, false);
        }
        else
        {
            arrow = new Arrow(arrowType, arrows.size(), true,  true, false);
        }
	...
	**/
	...
	private class Arrow
	{
	    ...
	    public double orgX = X_MIN;
	    public double orgY = Y_MIN;
	    public double endX = X_MIN + 50;
	    public double endY = Y_MIN;
